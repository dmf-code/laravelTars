    ...
    function cities()
    {
        return [
            ...
            '吉林省' => [
                ...
                '延边市' => ['延吉市', '图们市', '敦化市', '珲春市', '龙井市', '和龙市', '汪清县', '安图县', '其他']
            ],
            '黑龙江省' => [
            ...
            '安徽省' => [
                '合肥市' => ['瑶海区', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县', '其他'],
            ...
            '湖北省' => [
                ...
                '襄樊市' => ['襄城区', '樊城区', '襄阳区', '南漳县', '谷城县', '保康县', '老河口市', '枣阳市', '宜城市', '其他'],
                '鄂州市' => ['梁子湖区', '华容区', '鄂城区', '其他'],
                ...
                '随州市' => ['曾都区', '随县', '广水市', '其他'],
                '恩施市' => ['恩施市', '利川市', '建始县', '巴东县', '宣恩县', '咸丰县', '来凤县', '鹤峰县', '其他'],
                '仙桃市' => ['沙嘴街道', '干河街道', '龙华山办事处', '郑场镇', '毛嘴镇', '豆河镇', '三伏潭镇', '胡场镇', '长倘口镇', '西流河镇', '沙湖镇', '杨林尾镇', '彭场镇', '张沟镇', '郭河镇', '沔城回族镇', '通海口镇', '陈场镇', '工业园区', '九合垸原种场', '沙湖原种场', '五湖渔场', '赵西垸林场', '畜禽良种场', '排湖风景区', '其他'],
                '潜江市' => ['园林办事处', '杨市办事处', '周矶办事处', '广华办事处', '泰丰办事处', '高场办事处', '竹根滩镇', '渔洋镇', '王场镇', '高石碑镇', '熊口镇', '老新镇', '浩口镇', '积玉口镇', '张金镇', '龙湾镇', '江汉石油管理局', '潜江经济开发区', '周矶管理区', '后湖管理区', '熊口管理区', '总口管理区', '白鹭湖管理区', '运粮湖管理区', '浩口原种场', '其他'],
                '天门市' => ['竟陵街道', '侨乡街道开发区', '杨林街道', '多宝镇', '拖市镇', '张港镇', '蒋场镇', '汪场镇', '渔薪镇', '黄潭镇', '岳口镇', '横林镇', '彭市镇', '麻洋镇', '多祥镇', '干驿镇', '马湾镇', '卢市镇', '小板镇', '九真镇', '皂市镇', '胡市镇', '石河镇', '佛子山镇', '净潭乡', '蒋湖农场', '白茅湖农场', '沉湖管委会', '其他'],
                '神农架市' => ['松柏镇', '阳日镇', '木鱼镇', '红坪镇', '新华镇', '九湖镇', '宋洛乡', '下谷坪', '土家族乡', '其他']
            ],
            '湖南省' => [
                ...
                '湘西市' => ['吉首市', '泸溪县', '凤凰县', '花垣县', '保靖县', '古丈县', '永顺县', '龙山县', '其他']
            ],
            '广东省' => [
            ...
            '海南省' => [
                ...
                '三沙市' => ['西沙南沙中沙', '其他'],
                '五指山市' => ['通什镇', '南圣镇', '毛阳镇', '番阳镇', '畅好乡', '毛道乡', '水满乡', '国营畅好农场', '其他'],
                '琼海市' => ['嘉积镇', '万泉镇', '石壁镇', '中原镇', '博鳌镇', '阳江镇', '龙江镇', '潭门镇', '塔洋镇', '长坡镇', '大路镇', '会山镇', '国营东太农场', '国营东红农场', '国营东升农场', '彬村山华侨农场', '其他'],
                '儋州市' => ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '三都镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇', '国营西培农场', '国营西联农场', '国营蓝洋农场', '国营八一农场', '洋浦经济开发区', '华南热作学院', '其他'],
                '文昌市' => ['文城镇', '重兴镇', '蓬莱镇', '会文镇', '东路镇', '潭牛镇', '东阁镇', '文教镇', '东郊镇', '龙楼镇', '昌洒镇', '翁田镇', '抱罗镇', '冯坡镇', '锦山镇', '铺前镇', '公坡镇', '国营东路农场', '国营南阳农场', '国营罗豆农场', '其他'],
                '万宁市' => ['万城镇', '龙滚镇', '和乐镇', '后安镇', '大茂镇', '东澳镇', '礼纪镇', '长丰镇', '山根镇', '北大镇', '南桥镇', '三更罗镇', '国营东兴农场', '国营东和农场', '国营新中农场', '兴隆华侨农场', '地方国营六连林场', '其他'],
                '东方市' => ['八所镇', '东河镇', '大田镇', '感城镇', '板桥镇', '三家镇', '四更镇', '新龙镇', '天安乡', '江边乡', '国营广坝农场', '东方华侨农场', '其他'],
                '定安市' => ['定城镇', '新竹镇', '龙湖镇', '黄竹镇', '雷鸣镇', '龙门镇', '龙河镇', '岭口镇', '翰林镇', '富文镇', '国营中瑞农场', '国营南海农场', '国营金鸡岭农场', '其他'],
                '屯昌市' => ['屯城镇', '新兴镇', '枫木镇', '乌坡镇', '南吕镇', '南坤镇', '坡心镇', '西昌镇', '国营中建农场', '国营中坤农场', '其他'],
                '澄迈市' => ['金江镇', '老城镇', '瑞溪镇', '永发镇', '加乐镇', '文儒镇', '中兴镇', '仁兴镇', '福山镇', '桥头镇', '大丰镇', '国营红光农场', '国营西达农场', '国营金安农场', '其他'],
                '临高市' => ['临城镇', '波莲镇', '东英镇', '博厚镇', '皇桐镇', '多文镇', '和舍镇', '南宝镇', '新盈镇', '调楼镇', '国营红华农场', '国营加来农场', '其他'],
                '白沙市' => ['牙叉镇', '七坊镇', '邦溪镇', '打安镇', '细水乡', '元门乡', '南开乡', '阜龙乡', '青松乡', '金波乡', '荣邦乡', '国营白沙农场', '国营龙江农场', '国营邦溪农场', '其他'],
                '昌江市' => ['石碌镇', '叉河镇', '十月田镇', '乌烈镇', '昌化镇', '海尾镇', '七叉镇', '王下乡', '国营红林农场', '国营霸王岭林场', '海南矿业联合有限公司', '其他'],
                '乐东市' => ['抱由镇', '万冲镇', '大安镇', '志仲镇', '千家镇', '九所镇', '利国镇', '黄流镇', '佛罗镇', '尖峰镇', '莺歌海镇', '国营山荣农场', '国营乐光农场', '国营保国农场', '国营尖峰岭林业公司', '国营莺歌海盐场', '其他'],
                '陵水市' => ['椰林镇', '光坡镇', '三才镇', '英州镇', '隆广镇', '文罗镇', '本号镇', '新村镇', '黎安镇', '提蒙乡', '群英乡', '国营岭门农场', '国营南平农场', '国营吊罗山林业公司', '其他'],
                '保亭市' => ['保城镇', '什玲镇', '加茂镇', '响水镇', '新政镇', '三道镇', '六弓乡', '南林乡', '毛感乡', '国营新星农场', '海南保亭热带作物研究所', '国营金江农场', '国营三道农场', '其他'],
                '琼中市' => ['营根镇', '湾岭镇', '黎母山镇', '和平镇', '长征镇', '红毛镇', '中平镇', '吊罗山乡', '上安乡', '什运乡', '国营阳江农场', '国营乌石农场', '国营加钗农场', '国营长征农场', '国营黎母山林业公司', '其他']
            ],
            '重庆市' => [
            ...
            '四川省' => [
                ...
                '阿坝市' => ['汶川县', '理县', '茂县', '松潘县', '九寨沟县', '金川县', '小金县', '黑水县', '马尔康县', '壤塘县', '阿坝县', '若尔盖县', '红原县', '其他'],
                '甘孜市' => ['康定县', '泸定县', '丹巴县', '九龙县', '雅江县', '道孚县', '炉霍县', '甘孜县', '新龙县', '德格县', '白玉县', '石渠县', '色达县', '理塘县', '巴塘县', '乡城县', '稻城县', '得荣县', '其他'],
                '凉山市' => ['西昌市', '木里藏族自治县', '盐源县', '德昌县', '会理县', '会东县', '宁南县', '普格县', '布拖县', '金阳县', '昭觉县', '喜德县', '冕宁县', '越西县', '甘洛县', '美姑县', '雷波县', '其他']
            ],
            '贵州省' => [
                ...
                '黔西南市' => ['兴义市', '兴仁县', '普安县', '晴隆县', '贞丰县', '望谟县', '册亨县', '安龙县', '其他'],
                '毕节市' => ['毕节市', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县', '其他'],
                '黔东南市' => ['凯里市', '黄平县', '施秉县', '三穗县', '镇远县', '岑巩县', '天柱县', '锦屏县', '剑河县', '台江县', '黎平县', '榕江县', '从江县', '雷山县', '麻江县', '丹寨县', '其他'],
                '黔南市' => ['都匀市', '福泉市', '荔波县', '贵定县', '瓮安县', '独山县', '平塘县', '罗甸县', '长顺县', '龙里县', '惠水县', '三都水族自治县', '其他']
            ],
            '云南省' => [
            ...
            '西藏自治区' => [
                ...
                '那曲市' => ['那曲县', '嘉黎县', '比如县', '聂荣县', '安多县', '申扎县', '索县', '班戈县', '巴青县', '尼玛县', '其他'],
            ...
            '台湾省' => ['台北市', '高雄市', '基隆市', '台中市', '台南市', '新竹市', '嘉义市', '台北县', '宜兰县', '新竹县', '桃园县', '苗栗县', '台中县', '彰化县', '南投县', '嘉义县', '云林县', '台南县', '高雄县', '屏东县', '台东县', '花莲县', '澎湖县', '其他']
        ];
    }
}
